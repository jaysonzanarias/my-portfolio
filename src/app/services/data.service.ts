...
let data = [
  {
    ...
    features: "Sleek and responsive design, created from scratch, GitHub hosted.",
    details:
      `I've created this site using Angular for front-end development, Angular Material for some UI elements (but still most of the behavior and looks is pure JavaScript and CSS that I’ve created manually), and hosted here in GitHub (for now). It is still work in progress and I will update occasionally in the future. This will serve as a medium for me to showcase some of the projects and technologies that I'm currently working on and projects I had that are hard to display in common platform such as LinkedIn. Unfortunately, some of the awesome projects that I've done are NDA protected and I cannot share them here.
...
The layout of this site is simple:
    ...
    •	Portfolio - is this page where I've listed some of the projects I've worked on.
...
Since I'm not a UI/UX expert, I tried first copying different porfolio designs I find interesting and tried recreating them on my own from scratch (allowing me to learn and improve a lot in the process) then adding a little twist/design ideas of my own.
Below are my main resources for web design ideas.
    •	YouTube: DesignCourse
    •	YouTube: Traversy Media
    •	Rafael Caferati: https://caferati.me/ (this is one the most awesome portfolio I've seen and my main inspiration for this site)
...
For fun, I’ll be listing the different challenges I’ve faced when developing my portfolio (I’ll add more as I continue to improve this site):
    ...
    images: [
      { image_name: "my_port_01.jpg", caption: "Home Section" },
      { image_name: "my_port_02.jpg", caption: "Portfolio Section" },
      { image_name: "my_port_03.jpg", caption: "Skills Section" },
      { image_name: "my_port_old_design_01.png", caption: "(old design)" },
      { image_name: "my_port_old_design_02.png", caption: "(old design)" },
      { image_name: "my_port_old_design_03.png", caption: "(old design)" },
    ]
  },

  {
    ...
    features: "Rich charts/diagram web app, hardware programming, user role management, message/task routing and assignment, database CRUD operations, heavy logs data manipulation.",
    details: "This is a prototype I created for a side project I had, it's a monitoring and management web app for the OEE of a particular company. In this project I used React for front-end development and PostgreSQL for database. I also studied PLC language for programming the hardware devices.",
    images: [
...
I used Angular and Angular Material for the UI and PostgreSQL for the database.`,
  ...
  },
  {
    name: "Project Iris",
    type: ["mobile", "backend"],
    features: "Cool and innovative mobile application, Image Processing (Machine Learning), Text-to-Speech and Speech-to-Text application, rapid development.",
    ...
    details: `Together with four other developers, Project Iris, was our entry for our tribe's internal hackathon event that lasted for two days. Project Iris is a mobile app for the blind, the goal is to help them in many things (e.g. recognize and locate objects/registered faces, identify obstacles or danger, locate pedestrian crossing or nearby places, etc.) and serve all of them in a single app and for free. Initially started as a hackathon entry in the office, with simple functionality like capturing an image and searching in it an object via speech recognition, doing an image processing, and then telling the object's location via text-to-speech technology. 
...
Main technologies used were React Native for the mobile app; Python for our backend and Machine Learning; Google's Translator, and Text-to-Speech/Speech-to-Text. My main responsibilities were in the mobile app's development, code integration developed by my teammates, and mobile app to backend communications.`,
  ...
  },
  {
    ...
    features: "Shows Ways of Working (WoW) compliance status (via visualization using charts/diagrams), data aggregation, database CRUD operations, REST API communications, GitLab API, etc.",
    details:
...
Some of the functionalities of this tool is already provided by GitLab UI but what I did is consolidate them for easy viewing and make it ideal for displaying. I’ve used React for front-end, Chart.js for visualization of different charts, and Node.js for the backend.`
    ,
    images: [
  ...
  },
  {
    ...
    features: "Provides end-to-end business solution from choosing of an item to its payment, provides administrative part for updating product and user records, heavy UI design.",
  ...
  },
  {
    ...
    features: "Programming of Biometric scanner, database CRUD operations, etc.",
  ...
  },
  {
    ...
    features: "Mobile app development, web scraping, heavy UniT Test creation and documentation.",
  ...
  },
  {
    ...
    features: "Complete end-to-end library solution (complete management of library materials and user records), AI application thru NLP, text-to-speech technology, database CRUD operations, etc.",
  ...
  },
  {
    ...
    features: "Database CRUD operations, handling of different business rules, exporting of results.",
  ...
  },
  {
    ...
    type: ["backend"],
    technologies: "Java",
    features: "Simple app for consuming public REST API of Philippine stocks.",
  ...
  },
  {
    ...
    type: ["backend"],
    technologies: "Java",
    features: "REST API communication, faster log analysis, data aggregation and manipulation.",
...
Before, when centralized logs repository with different powerful built-in tools is not yet a thing, analyzing logs to check for errors or system wide behavior is a common task made by developers and I've experienced personally in my career. With these, I find myself creating (beyond of my work or our target deliverables) a couple of times simple Java applications for automating the reading and basic analyzing of large log files. From showing of different information such as duration of execution, displaying different types of errors grouped by category, to triggering events based from the retrieve information and more. These helps in shortening the time needed to analyze different log files and allows us to easily see what’s happening within the system by seeing a summarized reports of the log files.`,
  ...
  },
  {
    ...
    type: ["desktop", "game"],
    features: "Game development, integrated with IT theme, compilation of different puzzles and game mechanics.",
  ...
  },
  {
    ...
    features: "Simple but cool Java app.",
  ...
  },
  {
    ...
    features: "Game creation using Unity game engine; custom assets, game mechanics and programming.",
